...
namespace HealthConnect.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        public PatientController(IPatientRepository patientRepository, IMapper mapper, UserManager<HealthConnect.Models.User> userManager, IAppointmentRepository appointmentRepository)
        {
